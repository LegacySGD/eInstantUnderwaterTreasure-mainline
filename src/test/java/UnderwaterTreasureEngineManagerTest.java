...
public class UnderwaterTreasureEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(UnderwaterTreasureEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/UnderwaterTreasure/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/UnderwaterTreasure/InitOutcome.xml").getDocumentElement();
